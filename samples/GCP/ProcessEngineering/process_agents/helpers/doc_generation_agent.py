...
from .utils import getProperty, _detect_schema_type, _paths_for_schema
    ...
    try:
        ...
        if resolved_type is None:
            ...
            if os.path.exists(design_path) and not os.path.exists(process_path):
                ...
                # Covers: only process exists, both exist, or neither
                # exists -- "process" is the default in every ambiguous
                # case, preserving the original hardcoded-path behavior.
